  ...
  for key, value in response.items():
      if key == 'FaceDetails':
          for people_att in value:
              ...
              string = "This person is "+gender+". Age of this person is in range from "+low_age_range+" to " + high_age_range + " years old. This person "+is_smiling+" Emotions: "+emotion
  return string
...
def get_image_transcription(photo: str):
    ...
    textractmodule = boto3.client('textract', aws_access_key_id = "", aws_secret_access_key = "", region_name='us-east-1')
